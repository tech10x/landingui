...
const DevFeature = () => {
  return (
    <div>
      <div className="text-black bg-green-100 py-12">
        <div className="max-w-full mx-auto">
          <h2 className="sm:text-4xl text-2xl font-extrabold text-center pt-12 mb-16">
            Discover Our Exclusive Features
          </h2>
          <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-12 max-md:max-w-full mx-auto">
            <div className="rounded-xl group p-8 text-center hover:bg-white hover:text-purple-800 hover:shadow-xl transition duration-300">
              ...
              <p className="text-black group-hover:text-gray-500 text-sm">
