  ...
  return (
    <div className='bg-pink-100 mt-12 pb-36 pt-2'>
      ...
      <div className='flex flex-row'>
         <div className='mx-2 hover:rounded-md transition-transform hover:scale-110'>
            <Image src={amazonReview} alt='amazon-review' width={200} height={200}/>
         </div>

         <div className='relative top-10 mx-2 hover:rounded-md transition-transform hover:scale-110'>
            <Image src={clarity} alt='clarity' width={200} height={200}/>
         </div>

         <div className='relative top-20 mx-2 hover:rounded-md transition-transform hover:scale-110'>
         ...
         <div className='relative top-2 mx-2 hover:rounded-md transition-transform hover:scale-110'>
            <Image src={googleAds} alt='google-ads' width={200} height={200}/>
         </div>

         <div className='relative bottom-5 mx-2 hover:rounded-md transition-transform hover:scale-110'>
         ...
         <div className='relative top-11 mx-2 hover:rounded-md transition-transform hover:scale-110'>
            <Image src={mailchimp} alt='mailchimp' width={200} height={200}/>
         </div>

         <div className='relative top-5 mx-2 hover:rounded-md transition-transform hover:scale-110'>
            <Image src={privy} alt='privy' width={200} height={200}/>
         </div>

         <div className='relative mx-2 bottom-2 hover:rounded-md transition-transform hover:scale-110'>
