...
import firstHeroBulletIcon from '@/assets/icons/bullet-icon/bullet-icon-1.png';
import secondHeroBulletIcon from '@/assets/icons/bullet-icon/bullet-icon-2.png';
import thridHeroBulletIcon from '@/assets/icons/bullet-icon/bullet-icon-3.png';
